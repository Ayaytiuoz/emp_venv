    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chef_Service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Task_Management.chef_service')),
            ],
        ),
        migrations.CreateModel(
            name='Projet',
            fields=[
                ...
                ('Equipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Task_Management.equipe')),
            ],
        ),
        migrations.CreateModel(
            name='Tache',
            fields=[
                ...
                ('Etat', models.CharField(choices=[('en cours', 'EN COURS'), ('fin', 'FIN')], default='En attente', max_length=20)),
                ('Employe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Task_Management.employe')),
                ('Projet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Task_Management.projet')),
            ],
        ),
        migrations.AddField(
            model_name='employe',
            name='Equipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Task_Management.equipe'),
        ),
    ]
